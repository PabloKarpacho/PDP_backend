<#--
  Info page template for Teach-Space Keycloak theme
-->
<!DOCTYPE html>
...
<body class="login-pf-page">
    ...
    <main class="login-content">
        <div class="form">
            <#if header??>
                <h1 class="form-title">${msg(header)}</h1>
            <#else>
                <h1 class="form-title">${msg("infoTitle")}</h1>
            </#if>

            <div class="helper-text">${(message.summary!'')?no_esc}</div>
